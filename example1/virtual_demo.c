...
osThreadDef (led_Thread1, osPriorityBelowNormal, 1, 0);                // thread A
osThreadDef (led_Thread2, osPriorityNormal, 1, 0);           // thread B
osThreadDef (led_Thread3, osPriorityAboveNormal, 1, 0);  								// thread C
